...
public class Utility {
	...
	public static void send(String toEmail, String subject, String body) {
		final String fromEmail = "nilam.godse1997@gmail.com"; // requires valid gmail id
		final String password = "wel123456"; // correct password for gmail id
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("nilam.godse1997@gmail.com", false));
